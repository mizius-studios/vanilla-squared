...
public class VSQControls {
    ...
    public static void initialize() {
        ...
        specialEffectKey = KeyMappingHelper.registerKeyMapping(new KeyMapping("vsq.gui.controls.vsq.keybinds.special_effect", InputConstants.Type.MOUSE, GLFW.GLFW_MOUSE_BUTTON_5, vsqControlsCategory));
    }
}
